...
<body>
    <section class="welcome-area"
        style="background-image: url(assets/img/bg/1.jpg);  background-size:cover; background-position: center center;">
        <div class="container">
            <div class="row">
    ...
    <!-- Latest jQuery -->
    <script src="{{asset('frontent_assets/js/jquery-1.12.4.min.js')}}"></script>
